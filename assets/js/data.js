...
const defaultState = {
  ...
  events: [
    ...
    { id: "ev_strength",  name: "Strength Zone",  zone: 2, order: 2, durationMinutes: 20, timeCapMinutes: 20, scored: true,  higherIsBetter: true,  scoreFormat: "poids total (kg)",   scoreUnit: "kg", notes: "0–6 min : 1RM Strict Press | 6–12 min : 3RM Back Squat | 12–18 min : 5RM Deadlift. Score = somme des charges maximales.", subFields: [{key:"press",label:"Press 1RM",unit:"kg"},{key:"squat",label:"Squat 3RM",unit:"kg"},{key:"deadlift",label:"Deadlift 5RM",unit:"kg"}] },
    ...
    { id: "ev_endurance", name: "Endurance Zone", zone: 4, order: 4, durationMinutes: 30, timeCapMinutes: 22, scored: true,  higherIsBetter: true,  scoreFormat: "distance totale (m)", scoreUnit: "m",  notes: "Run + Row en alternance. LITE : 500m/tour | ATHX : 750m/tour | PRO : 1000m/tour. Score = distance totale cumulée." },
    ...
    { id: "ev_metcon",    name: "MetCon X Zone",  zone: 6, order: 6, durationMinutes: 25, timeCapMinutes: 25, scored: true,  higherIsBetter: false, scoreFormat: "temps ou reps (time cap)", scoreUnit: "s", timeCap: true, timeCapSeconds: 1500, notes: "7 stations : 60 cal Ski-Erg → GTOH → 60m Sandbag Carry → 60 Box Jump Overs → 60m DB Lunges → 60m Burpee Broad Jumps → 60 cal Ski-Erg. Time cap 25 min. Si time cap atteint : entrer le nombre de répétitions complétées." },
  ],
  scores: [],
  news: [],
  updatedAt: null,
